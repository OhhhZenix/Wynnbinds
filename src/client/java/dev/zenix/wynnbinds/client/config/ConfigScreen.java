...
import dev.zenix.wynnbinds.client.Utils;
...
public class ConfigScreen {
        ...
        public static Screen create(Screen parent) {
                ...
                HashMap<String, ArrayList<String>> allKeysByCategory = Utils.getAllKeysByCategory();
                ...
                for (Entry<String, ArrayList<String>> entry : Utils.getCaptureKeysByCategory()
                                .entrySet()) {
                        String category = entry.getKey();
                        ArrayList<String> translationKeys = entry.getValue();
                ...
                // Current
                String currentCharacterId = Utils.getCharacterId();
                if (!currentCharacterId.equals(Utils.DUMMY_CHARACTER_ID)) {
